  ...
  <section id="page5" className="section-gray">
            <div className="row">
                <div className="col-lg-12">
                     <h2 className="heading">About My Research</h2>
                    <div className="row">
                        <div className="col-md-6">
                            ...
                            <p>Betrayed cheerful declared end and. Questions we additions is extremely
                                incommode. Next half add call them eat face. Age lived smile six defer
                                bed their few. Had admitting concluded too behaviour him she. Of death
                                to or to being other.</p>
                        </div>
                        <div className="col-md-6">
                            ...
                            <p>Saw yet kindness too replying whatever marianne. Old sentiments resolution
                                admiration unaffected its mrs literature. Behaviour new set existence dashwoods.
                                It satisfied to mr commanded consisted disposing engrossed. Tall snug do
                                of till on easy. Form not calm new fail.</p>
                        </div>
                    </div>
                </div>
            </div>
